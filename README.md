...
* Install the required dependencies by doing: `sudo apt-get install python3-flask python3-pip python3-rpi.gpio gunicorn3 dos2unix python3-pexpect python3-smbus pigpio python3-pigpio  bluez-tools dnsmasq bridge-utils python3-pil` then `sudo pip3 install flask-cors Flask-Sockets adafruit-circuitpython-ssd1306 adafruit-circuitpython-vl53l0x`. `sudo systemctl enable pigpiod`
